...
import { cardAmounts, type CardAmounts } from '@conquerist/shared';
import { render, screen, userEvent } from '../test/dom';
import { HandPanel } from './HandPanel';

const hand: CardAmounts = cardAmounts({ brick: 2, lumber: 3, wool: 0, grain: 1, ore: 0 });
...
describe('Handkarten', () => {
  ...
  it('sagt es, wenn die Hand leer ist, statt eine leere Flaeche zu zeigen', () => {
    const empty: CardAmounts = cardAmounts({ brick: 0, lumber: 0, wool: 0, grain: 0, ore: 0 });
