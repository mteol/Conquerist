...
/**
 * Etappe 0: nur Diagnose. Kein Design, keine Spieloberflaeche.
 * Zeigt Verbindungszustand, schickt einen Anwendungs-Ping und stellt die
 * gemessene Umlaufzeit samt Server-Zeitstempel dar.
 */
  ...
  return (
    <main className="page">
      <header className="page__header">
        <h1>Conquerist</h1>
        <p className="page__subtitle">Etappe 0 &middot; Grundgeruest und WS-Ping</p>
      </header>
      ...
      <section className="card">
        <h2 className="card__title">Verbindung</h2>
        <dl className="metrics">
